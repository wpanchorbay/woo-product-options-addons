...
if ( ! function_exists( 'woo_product_options_addons_log' ) ) {
	/**
	 ...
	 * @return void
	 */
	function woo_product_options_addons_log( $message, $level = 'INFO' ) {
		...
		$logger->log( $wc_level, $formatted_message, array( 'source' => 'woo-product-options-addons' ) );
	}
}


if ( ! function_exists( 'woo_product_options_addons_get_value' ) ) {
	/**
	 ...
	 * @return mixed
	 */
	function woo_product_options_addons_get_value( $target, $key, $default_value = null ) {
